...
- **전역 단축키(액션 할당)**: 키 조합을 액션(**꽥 / 다음 스킨 / 숨기기·보이기 / 설정 열기**)에 자유롭게 할당. 여러 개 등록 가능하고, 다른 창을 쓰는 중에도 작동한다. (기본 `Ctrl+Shift+D` = 꽥)
...
- **v0.3** — ✅ 스킨팩(`.rduck`) 임포트·적용·관리 · ✅ 할당 가능한 액션 핫키 · (다음) 여러 마리 소환 ([설계](docs/DESIGN-v0.3.md))
